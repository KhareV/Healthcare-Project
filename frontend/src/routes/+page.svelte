...
<svelte:head>
	<title>Personalized Patient Recovery Trajectory — Performance V2</title>
	<meta name="description" content="Retrospective ICU time-series forecasting: recovery trajectory, remaining ICU stay time, and new organ-support initiation risk, replayed cutoff by cutoff from a synthetic research benchmark." />
...
{#if preloaderMounted}
	<div class:preloader--closing={ready} class="preloader" aria-label="Initializing Personalized Patient Recovery Trajectory">
		...
		<div class="preloader__inner">
			...
			<div class="preloader__identity">
				<div class="preloader__mini">PERSONALIZED PATIENT RECOVERY TRAJECTORY</div>

				<div class="preloader__quote">
					<div class="preloader__quote-text">
						<TypingAnimation
							words={['Recompute at every cutoff.', 'Recovery, forecast independently.', 'A retrospective replay, not a guess.', 'Understand the pattern.', 'Synthetic benchmark, real models.']}
...
<div class="site-shell">
	...
	========================================================= -->
	<nav class="nav">
		<a class="brand" href="#top" aria-label="Personalized Patient Recovery Trajectory home">
			<span class="brand__mark">P</span>
			<span class="brand__name">PRT · V2</span>
		</a>

		<div class="nav__links">
			<a href="#technology">Method</a>
			<a href="#signals">Outputs</a>
	...
	<main id="top">
		...
		<section class="hero section-dark">
			...
			<div class="hero__technical">
				<span>PRT · V2 / 01</span>
				<span>RETROSPECTIVE SEQUENTIAL REPLAY</span>
				<span>RECOVERY · ICU TIME · SUPPORT RISK</span>
			</div>
				...
				<div class="hero__content">
					<div class="hero__copy-container">
						<BlurFade inView={true} direction="up" offset={18} blur="10px" duration={0.85}>
							...
							<div class="eyebrow eyebrow--teal">SYNTHETIC BENCHMARK · NOT REAL-TIME CLINICAL PREDICTION</div>
							<h1>
								Recovery.<br />
								<span class="text-gradient">Recomputed</span><br />
								<span>at every cutoff.</span>
							</h1>
							<p class="hero__lede">
								A retrospective ICU time-series research prototype: independent +24h/+48h recovery forecasts, remaining ICU stay time, and calibrated new organ-support initiation risk — recomputed from raw history truncated at each replay cutoff, by four frozen XGBoost models, never a lookup table.
							</p>
							<div class="hero__actions">
								<a class="button button--light" href="/demo">
									<span>Launch guided demo</span><span>↗</span>
								</a>
								<a class="text-link" href="/patients">Open patient replay<span>↗</span></a>
							</div>
							</div>
						</BlurFade>
					</div>
		...
		<section class="final section-dark">
			...
			<div class="container relative z-10 text-center flex flex-col items-center">
				...
				<div class="final__headline">
					<LineShadowText content="Recovery, forecast" shadowColor="#2bb8b0" as="div" />
					<LineShadowText content="cutoff by cutoff." shadowColor="#2bb8b0" as="div" />
				</div>
	...
	<footer class="footer">
		<div class="footer__brand">
			<div class="brand"><span class="brand__mark">P</span><span class="brand__name">PRT · V2</span></div>
