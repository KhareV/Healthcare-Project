...
def build_final_release(code_commit: str, bundle_sha256: str) -> dict:
    ...
    return {
        ...
        "parents": {
            ...
            "health_record_architecture_doc": _ref("docs/product_v2/HEALTH_RECORD_ARCHITECTURE.md"),
        },
        "custom_record_schema_version": "custom_record_v1",
        "auth_mode": "clerk_verified_with_local_dev_fallback",
        "health_record": {
            "status": "HEALTH_RECORD_V2_COMPLETE",
            ...
            "report_storage_version": "local_report_storage_v1",
            "health_record_api_version": "health_record_api_v1",
            "report_intelligence_version": "report_intelligence_v1",
            "frontend_version": "0.1.0",
        },
        "screenshot_evidence_count": len(list(evidence_dir.glob("*.png"))),
        "screenshot_evidence_dir": "docs/evidence/product_v2/",
        "test_evidence": {
            "backend_pytest_passed": 1574,
            "backend_pytest_skipped": 21,
            "backend_pytest_failed": 0,
            "frontend_playwright_passed": 15,
            "frontend_playwright_failed": 0,
            "svelte_check_errors": 0,
            "mongodb_integration_tests_passed": 19,
            "report_intelligence_tests_passed": 4,
            "note": "Point-in-time counts from the Report Intelligence regression run; re-run the suites for current numbers.",
        },
